package com.boa.embeddedInvestment.configs;
...
public class SecurityConfiguration {
    ...
    public WebSecurityCustomizer webSecurityCustomizer() {
        return (web) -> web.ignoring().requestMatchers(new AntPathRequestMatcher("/h2-console/**"), new AntPathRequestMatcher("/error"));
    }
